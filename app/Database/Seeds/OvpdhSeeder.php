...
class OvpdhSeeder extends Seeder
{
    ...
    private function seedUsers(): void
    {
        ...
        $usersData = [
            ['email' => 'admin@ovpdh.pucminas.br',       'username' => 'admin',       'password' => 'Admin@2024!',   'group' => 'admin',        'name' => 'Administrador OVPDH'],
            ['email' => 'superadmin@ovpdh.pucminas.br',  'username' => 'superadmin',  'password' => 'Super@2024!',   'group' => 'superadmin',   'name' => 'Super Administrador'],
            ['email' => 'voluntario@ovpdh.pucminas.br',  'username' => 'voluntario1', 'password' => 'Voluntario@24', 'group' => 'voluntario',   'name' => 'Maria das Graças Silva'],
            ['email' => 'colaborador@ovpdh.pucminas.br', 'username' => 'colaborador1','password' => 'Colab@2024!',   'group' => 'colaborador',  'name' => 'João Paulo Ferreira'],
            ['email' => 'advogado@ovpdh.pucminas.br',    'username' => 'advogado1',   'password' => 'Adv@2024!',     'group' => 'advogado',     'name' => 'Dr. Carlos Eduardo Mendes'],
            ['email' => 'academico@ovpdh.pucminas.br',   'username' => 'academico1',  'password' => 'Acad@2024!',    'group' => 'academico',    'name' => 'Profa. Dra. Ana Lúcia Borges'],
            ['email' => 'ativista@ovpdh.pucminas.br',    'username' => 'ativista1',   'password' => 'Ativi@2024!',   'group' => 'ativista',     'name' => 'Pedro Henrique Costa'],
        ];
    ...
    private function seedProdutos(): void
    {
        $produtos = [
            ...
            [
                ...
                'ano'           => 2022,
                'publicacao'    => 'Editora PUC Minas',
                'doi'           => null,
                'link_externo'  => '#',
                'palavras_chave'=> 'racismo institucional; violência policial; direitos humanos; PUC Minas',
                'ativo'         => 1,
                'created_at'    => date('Y-m-d H:i:s'),
                'updated_at'    => date('Y-m-d H:i:s'),
            ],
            ...
            [
                ...
                'autores'       => 'Equipe OVPDH — PUC Minas',
